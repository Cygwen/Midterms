...
var reunion = new Reunion("Friday.February 4th",  "6:00-8:00 PM", "Ferrer Residences", "PInata.Games.cake and Fun" );
...
function Reunion(title, theme, date, time, location, activities){
  this.title = title;
  this.theme = theme;
  this.date = date;
  this.time = time;
